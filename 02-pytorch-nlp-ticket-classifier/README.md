...
- our training data is imbalance (as it was in project 01), the distribution of the data is follow:
...
General Inquiry                      44
Human Resources                      42
We need to keep it in mind when creating validation set, also we will need to use class weight balance mathods to handle this problem
